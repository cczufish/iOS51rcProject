...
{
    EIItemDetailsViewController *eiItemDetailsCtrl = [self.storyboard instantiateViewControllerWithIdentifier:@"EIItemDetailsView"];
    [self.navigationController pushViewController:eiItemDetailsCtrl animated:YES];
}
