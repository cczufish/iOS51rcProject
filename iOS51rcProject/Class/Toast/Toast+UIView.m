...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle = [CommonController CalculateFrame:title fontDemond:titleLabel.font sizeDemand:maxSizeTitle];
    ...
    if (message != nil) {
        ...
        CGSize expectedSizeMessage = [CommonController CalculateFrame:message fontDemond:messageLabel.font sizeDemand:maxSizeMessage];
